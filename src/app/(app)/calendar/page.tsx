          ...
          <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-[var(--shadow-sm)]">
            ...
            <div className="grid grid-cols-7 border-b border-border bg-muted/30">
              {WEEKDAYS.map((w) => (
                <div
                  key={w}
                  // See the bookings page: browser translation mangles these.
                  translate="no"
                  className="notranslate px-2 py-2 text-center text-[11px] font-semibold uppercase tracking-wider text-muted-foreground"
                >
                  {w}
                </div>
              ))}
