...
export const PAGE_HELP: Record<string, PageHelpContent> = {
  ...
  reports: {
    ...
    steps: [
      ...
      "Edit any section, reorder them, and use Tidy with AI to clean up the writing — you review each section before/after, can edit the ‘After’ text yourself, and Approve sections one by one as you scroll. Only approved sections are applied.",
